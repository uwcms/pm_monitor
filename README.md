...
You may find it at https://gitlab.cern.ch/WisconsinCMS/IPMI/pm_monitor
...
```sh
git remote set-url origin ssh://git@gitlab.cern.ch:7999/WisconsinCMS/IPMI/pm_monitor.git
```
...
```sh
git remote set-url origin https://gitlab.cern.ch/WisconsinCMS/IPMI/pm_monitor.git
```
